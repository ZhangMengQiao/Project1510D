...
public class TuiAdapter extends BaseAdapter{
    List<FirstBean.TuijianBean.ListBean> list;
    Context context;

    public TuiAdapter(List<FirstBean.TuijianBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        FirstBean.TuijianBean.ListBean listBeanX = list.get(position);
